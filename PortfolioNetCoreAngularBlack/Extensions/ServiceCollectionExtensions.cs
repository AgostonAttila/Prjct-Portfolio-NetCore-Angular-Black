...
namespace PortfolioNetCoreAngularBlack.Extensions
{
    public static class ServiceCollectionExtensions
    {
        ...
        {
            // Add framework services.//original was AddDbContextPool
            services.AddDbContext<PortfolioDbContext>(options =>
            {
                ...
                {
                    options.UseInMemoryDatabase("fund"); // Takes database name
                }
        ...
        public static IServiceCollection AddCustomLocalization(this IServiceCollection services, IHostEnvironment hostEnvironment)
        {
            var translationFile = File.ReadAllLines(Path.Combine(hostEnvironment.ContentRootPath, "translations.csv"));// hostEnvironment.GetTranslationFile();
